...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
      ...
      <h2>Get your car repaired now!</h2>
      <a href="{{url('book_service')}}" class="btn-get-started scrollto">Book Service</a>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="services" class="why-us">
      <div class="container">
        ...
        <div class="section-title" style="padding:100px">
          <span>Services</span>
          <h2>My Services</h2>
          <p>Monitor the progress of your services.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up">
            <div class="box">
              ...
              <form action="{{url('my_services_request')}}" method="POST">
